	...
	<section class="section-content">
		<div class="container">
			<header class="section-heading py-4 d-flex justify-content-between">
				...
				<a class="btn btn-primary" href="/admin/admin-add-user"
						...
						<c:forEach items="${users}" var="user" varStatus="status">
							<tr>
								...
								<c:if test="${user.activeFlag eq 1}">
									<td><button class="btn btn-success">Đang hoạt
											động</button></td>
								</c:if>
								...
								<td class="text-center text-nowrap"><a
									...
									href="/admin/admin-edit-user/${user.id}" role="button">Sửa</a>
									<a class="btn btn-danger" href="/admin/user/${user.id}"

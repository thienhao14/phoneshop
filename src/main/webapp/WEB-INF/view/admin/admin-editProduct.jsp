	...
	<section class="section-content">
		<div class="container">
			...
			<main class="add-book-form mb-5">
				<form action="/admin/admin-edit-product-data" th:object="${product}"
					method="POST" class="w-50">
					<input type="hidden" class="form-control" id="add-book-title"
						name="id" value="${product.id}">
					<div class="mb-3">
						<label for="add-book-title" class="form-label">Tên sản
							phẩm</label> <input type="text" class="form-control" id="add-book-title"
							name="name" value="${product.name}">
					</div>
					<div class="mb-3">
						<label for="add-book-author" class="form-label">Thương
							hiệu</label> <input type="text" class="form-control" id="add-book-author"
							name="brand" value="${product.name}">
					</div>
					<div class="mb-3">
						<label for="add-book-pages" class="form-label">Giá</label> <input
							type="number" class="form-control" id="add-book-pages"
							name="price" value="${product.price}">
					</div>
					<div class="mb-3">
						<label for="add-book-publisher" class="form-label">Khuyến
							mãi</label> <input type="text" class="form-control"
							id="add-book-publisher" name="discount"
							value="${product.discount}">
					</div>
					<div class="mb-3">
						<label for="add-book-description" class="form-label">Mô tả</label>
						<textarea class="form-control" id="add-book-description" rows="5"
					...
					<div class="mb-3">
						<label for="add-book-imageName" class="form-label">Hình</label> <input
							type="file" class="form-control" id="add-book-imageName"
							name="image">
					</div>
